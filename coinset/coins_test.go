...
func NewCoin(index int64, value czzutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = czzutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = czzutil.NewTxFromBytes(testSimpleCoinTxBytes)
