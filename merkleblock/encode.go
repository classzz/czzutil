...
func NewMerkleBlockWithFilter(block *czzutil.Block, filter *bloom.Filter) (*wire.MsgMerkleBlock, []uint32) {
...
func NewMerkleBlockWithTxnSet(block *czzutil.Block, txnSet []*chainhash.Hash) (*wire.MsgMerkleBlock, []uint32) {
...
// by a bloom.Filter
func (m *MerkleBlock) calcBlock(block *czzutil.Block) *wire.MsgMerkleBlock {
