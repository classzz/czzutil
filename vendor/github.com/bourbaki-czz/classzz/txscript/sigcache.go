...
func (s *SigCache) Exists(sigHash chainhash.Hash, sig *czzec.Signature, pubKey *czzec.PublicKey) bool {
	s.RLock()
...
func (s *SigCache) Add(sigHash chainhash.Hash, sig *czzec.Signature, pubKey *czzec.PublicKey) {
	s.Lock()
	defer s.Unlock()
